...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GalleryHotspot'
        db.create_table(u'saladoplayer_galleryhotspot', (
        ...
        db.send_create_signal(u'saladoplayer', ['GalleryHotspot'])


    def backwards(self, orm):
        # Deleting model 'GalleryHotspot'
        db.delete_table(u'saladoplayer_galleryhotspot')
